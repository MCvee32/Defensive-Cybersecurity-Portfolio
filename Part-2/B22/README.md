...
Every page on the site contains a visible hyperlink labelled "Admin" in the footer that navigates directly to /wp-admin. This basically "advertises" the admin login panel to every visitor, search engine crawler, and automated scanner. Reducing the effort required to launch a brute-force or credential stuffing attack.
...
Footer currently contains: "| <a href="https://sorrentotennisclub.com.au/wp-admin">Admin</a>"
