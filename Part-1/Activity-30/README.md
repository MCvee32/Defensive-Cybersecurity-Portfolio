# Part 1 - A30: Complete a Cybersecurity Module

### Module Chosen
I chose Module 4: Mitigating Cyber Security Risks (Technical Approaches) from TEQSA's Enchancing Cyber Security Awareness Training Program. 
This module focuses on the following:
- The CIA triad and its importance in an organisation's cyber security infrastructure
- The four categories of cyber security principles by the ACSC
- Implementation of preventive and detective controls
- Responding to cyber security incidents
- Mitigating risks of cyber attacks on higher education intangible assets
